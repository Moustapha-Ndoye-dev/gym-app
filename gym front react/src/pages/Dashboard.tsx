...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-4 sm:p-6 text-white shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-white opacity-10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/4 w-24 h-24 bg-indigo-400 opacity-20 rounded-full blur-2xl"></div>
        <div className="relative z-10">
          <h1 className="text-lg sm:text-xl font-extrabold mb-1 tracking-tight">Bonjour, {user?.username} 👋</h1>
          <p className="text-indigo-100 text-[11px] sm:text-[12px] font-medium max-w-xl leading-relaxed">Voici un résumé de l'activité de votre salle de sport aujourd'hui.</p>
        </div>
      </div>
